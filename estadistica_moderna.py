def moda(datos):
    ...
    #Obtiene los valores con la frecuencia máxima
...
def cuartil(datos, pos):
    ...
    #Obtiene el valor en esa posición
...
def cof_re(x, y):
    ...
    # Calcula las sumas de productos de las desviaciones de cada variable
    suma_producto = sum((xi - media_x) * (yi - media_y) for xi, yi in zip(x, y))
    
    # Calcula las sumas de los cuadrados de las desviaciones de cada variable
